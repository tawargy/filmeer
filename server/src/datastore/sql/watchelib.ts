...
_getWatchedUserFilme(userId:string,filmeId:string):Promise<Mywatched|undefined>
}
...
_getLibraryUserFilme(userId:string,filmeId:string):Promise<Mylibrary|undefined>
}
